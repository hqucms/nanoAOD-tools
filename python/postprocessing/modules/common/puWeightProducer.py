...
def puWeight_2016(): return puWeightProducer(pufile_mc2016, pufile_data2016, "pu_mc", "pileup", verbose=False, doSysVar=True)
def puAutoWeight_2016(): return puWeightProducer("auto", pufile_data2016, "pu_mc", "pileup", verbose=False)
...
def puWeight_2017(): return puWeightProducer(pufile_mc2017, pufile_data2017, "pu_mc", "pileup", verbose=False, doSysVar=True)
def puAutoWeight_2017(): return puWeightProducer("auto", pufile_data2017, "pu_mc", "pileup", verbose=False)
...
def puWeight_2018(): return puWeightProducer(pufile_mc2018, pufile_data2018, "pu_mc", "pileup", verbose=False, doSysVar=True)
def puAutoWeight_2018(): return puWeightProducer("auto", pufile_data2018, "pu_mc", "pileup", verbose=False)
