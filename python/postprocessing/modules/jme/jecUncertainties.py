...
class jecUncertProducerCpp(jecUncertProducer, object):
    ...
    def beginJob(self):
        ...
        for x in self.uncerts:
            self.vec_uncerts.push_back(x[0])
...
def jecUncert(): return jecUncertProducer("Summer16_07Aug2017_V11_MC")


def jecUncertAll(): return jecUncertProducer("Summer16_07Aug2017_V11_MC", allUncerts)

# python looper with C++ helper to calculate uncertainties, faster
# you can re-use the uncertainty values in modules running after this one in the same event loop


def jecUncert_cpp(): return jecUncertProducerCpp("Summer16_07Aug2017_V11_MC")


def jecUncertAll_cpp(): return jecUncertProducerCpp("Summer16_07Aug2017_V11_MC", allUncerts)
...
def jecUncert_cppOut(): return jecUncertProducerCpp("Summer16_07Aug2017_V11_MC", doCppOutput=True)


def jecUncertAll_cppOut(): return jecUncertProducerCpp("Summer16_07Aug2017_V11_MC", allUncerts, doCppOutput=True)


def jecUncertAK4Puppi(): return jecUncertProducer("Summer16_07Aug2017_V11_MC", jetFlavour="AK4PFPuppi")
def jecUncertAK8Puppi(): return jecUncertProducer("Summer16_07Aug2017_V11_MC", jetFlavour="AK8PFPuppi", jetColl="FatJet")
